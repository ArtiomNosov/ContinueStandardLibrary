//
//  AVLDictionaryTest.cpp
//  Lab2_3s
//
//  Created by  Николай Фонов on 16.12.2021.
//

#include "AVLDictionaryTest.hpp"


void avlDictionaryAdd(){
    auto* dict = new AVLDictionary<int, int>();
...
void avlDictionaryTests(){
    std::cout << "AVLDictionary Tests:\n";
    avlDictionaryAdd();
    std::cout << "1)AVLDictionary add test compleated\n";
    avlDictionaryGet();
    std::cout << "2)AVLDictionary get test compleated\n";
    avlDictionaryGetPair();
    std::cout << "3)AVLDictionary getPair test compleated\n";
    avlDictionaryGetSize();
    std::cout << "4)AVLDictionary getSize test compleated\n";
    avlDictionaryRemove();
    std::cout << "5)AVLDictionary remove test compleated\n";
}
